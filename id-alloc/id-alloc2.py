...
def allocAll():
    ...
    print("desire 1 lucks: {}".format(d1Lucks))
    print("desire 2 lucks: {}".format(d2Lucks))
    print("desire 3 lucks: {}".format(d3Lucks))
    print("desire 4 lucks: {}".format(d4Lucks))
    ...
    for k in sorted(idDetails):
        ...
        if desireType == DESIRE1:
            number = sortedDesire1IDs.index(k) + 1 + 33
            ...
            number = sortedDesire2IDs.index(k) + 1 + 45
            ...
            number = sortedDesire3IDs.index(k) + 1 + 61
            ...
            number = sortedDesire4IDs.index(k) + 1 + 61
    ...
    writer.save()
    print("write to file: {}".format(resultFile))
